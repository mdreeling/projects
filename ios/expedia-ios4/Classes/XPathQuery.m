...
NSArray *PerformXPathQuery(xmlDocPtr doc, NSString *query)
{
    ...
    if(xpathCtx == NULL)
	{
		NSLog(@"XPathQuery - Unable to create XPath context.");
		return nil;
    }
    ...
    if(xpathObj == NULL) {
		NSLog(@"XPathQuery - Unable to evaluate XPath.");
		return nil;
    }
	...
	if (!nodes)
	{
		NSLog(@"XPathQuery - Nodes was nil.");
		return nil;
	}
...
NSArray *PerformHTMLXPathQuery(NSData *document, NSString *query)
{
    ...
    if (doc == NULL)
	{
		NSLog(@"XPathQuery - Unable to parse.");
		return nil;
    }
